...
//       // Vulnerabilities 데이터 로드
//       console.log('📋 취약점 데이터 요청 중...');
...
//         updates: updates?.update_recommendations || []
//       };
...
//                     <span className="value">{dashboardData.security_overview?.total_vulnerabilities || 0}</span>
//                     <span className="label">Total Vulnerabilities</span>
//                   </div>
//                   <div className="metric warning">
//                     <span className="value">{dashboardData.security_overview?.affected_packages_count || 0}</span>
//                     <span className="label">Affected Packages</span>
//                   </div>
//                   <div className="metric info">
//                     <span className="value">{dashboardData.security_overview?.missing_packages_count || 0}</span>
//                     <span className="label">Missing Packages</span>
//                   </div>
//                   <div className="metric success">
//                     <span className="value">{dashboardData.security_overview?.recommended_updates_count || 0}</span>
...
//                 <p>Click <strong>"Analyze Repo"</strong> to get started with security scanning</p>
...
//               <p>Vulnerabilities: {dashboardData?.vulnerabilities ? `✅ ${dashboardData.vulnerabilities.length}개` : '❌ 없음'}</p>
//               <p>Packages: {dashboardData?.packages ? `✅ ${dashboardData.packages.length}개` : '❌ 없음'}</p>
//               <p>Updates: {dashboardData?.updates ? `✅ ${dashboardData.updates.length}개` : '❌ 없음'}</p>
//             </div>
...
//                     </div>
//                     <div className="metric">
//                       <span className="value">{dashboardData.packages?.length || 0}</span>
//                       <span className="label">Packages Analyzed</span>
//                     </div>
//                     <div className="metric">
//                       <span className="value">{dashboardData.updates?.length || 0}</span>
...
//             ) : (
//               <div>
//                 <p>먼저 <strong>"Analyze Repo"</strong> 버튼을 클릭하여 저장소 분석을 실행하세요.</p>
//               </div>
//             )}
//           </div>
//         )}
...
//                   <div key={index} className={`vuln-item severity-${vuln.severity?.toLowerCase() || 'unknown'}`}>
//                     <div className="vuln-header">
//                       <span className="vuln-id">{vuln.cve_id || `VULN-${index + 1}`}</span>
//                       <span className={`vuln-severity ${vuln.severity?.toLowerCase() || 'unknown'}`}>
//                         {vuln.severity || 'UNKNOWN'}
//                       </span>
//                     </div>
//                     <div className="vuln-details">
//                       <p><strong>Package:</strong> {vuln.package || 'Unknown'}</p>
//                       <p><strong>Version:</strong> {vuln.installed_version || 'Unknown'}</p>
...
//               </div>
//             ) : (
//               <p>먼저 분석을 실행하세요. 취약점 데이터가 없습니다.</p>
//             )}
//           </div>
//         )}
...
//               </div>
//             ) : (
//               <p>먼저 분석을 실행하세요. 패키지 데이터가 없습니다.</p>
//             )}
//           </div>
//         )}
//       </main>
